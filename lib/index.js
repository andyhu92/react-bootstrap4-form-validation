...
var RadioGroup = function (_BaseFormControl3) {
    ...
    _createClass(RadioGroup, [{
        key: 'getInputRef',
        value: function getInputRef() {
            var inputRef = document.querySelectorAll('[name=' + this.props.name + ']')[0];
            return inputRef;
        }
    }, {
        key: 'mapRadioItems',
...
var RadioItem = function (_Component) {
    ...
    function RadioItem() {
        ...
        return _ret = (_temp = (_this6 = _possibleConstructorReturn(this, (_ref = RadioItem.__proto__ || Object.getPrototypeOf(RadioItem)).call.apply(_ref, [this].concat(args))), _this6), _this6.onChange = function (e) {
            _this6.props.onChange(e, e.target.value);
    ...
    _createClass(RadioItem, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                domProps = _objectWithoutProperties(_props, ['checkError', 'containerStyle', 'label', 'inline', 'defaultValue', 'valueSelected', 'onChange']);

            var checkProps = defaultValue ? { defaultChecked: this.props.value === defaultValue } : { checked: this.props.value === valueSelected, onChange: this.onChange };
            return _react2.default.createElement(
                'div',
...
var FileInput = exports.FileInput = function (_BaseFormControl4) {
    ...
    function FileInput() {
        ...
        return _ret2 = (_temp2 = (_this7 = _possibleConstructorReturn(this, (_ref2 = FileInput.__proto__ || Object.getPrototypeOf(FileInput)).call.apply(_ref2, [this].concat(args))), _this7), _this7.handleChange = function () {
    ...
    _createClass(Checkbox, [{
        ...
        value: function render() {
            ...
            var label = props.label,
                ...
                domProps = _objectWithoutProperties(props, ['label', 'inline', 'containerStyle', 'className']);
...
var ValidationForm = exports.ValidationForm = function (_React$Component2) {
    ...
    function ValidationForm() {
        ...
        return _ret3 = (_temp3 = (_this10 = _possibleConstructorReturn(this, (_ref3 = ValidationForm.__proto__ || Object.getPrototypeOf(ValidationForm)).call.apply(_ref3, [this].concat(args))), _this10), _this10.inputs = {}, _this10.attachToForm = function (component) {
