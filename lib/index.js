...
var RadioItem = function (_Component) {
    ...
    _createClass(RadioItem, [{
        ...
        value: function render() {
            ...
            var checkProps = valueSelected !== undefined && onChange ? { checked: this.props.value === valueSelected, onChange: this.onChange } : { defaultChecked: this.props.value === defaultValue };
