...
exports.ValidationForm = exports.Checkbox = exports.SelectGroup = exports.FileInput = exports.RadioItem = exports.RadioGroup = exports.TextInputGroup = exports.TextInput = exports.BaseFormControl = undefined;
...
var BaseFormControl = exports.BaseFormControl = function (_React$Component) {
    ...
    function BaseFormControl(props) {
        ...
        _this.filterProps = function () {
            var _this$props = _this.props,
                ...
                rest = _objectWithoutProperties(_this$props, ['errorMessage', 'successMessage', 'validator', 'defaultErrorMessage', 'attachToForm', 'detachFromForm', 'setFormDirty', 'label', 'immediate', 'inline', 'buttonBody', 'onButtonClick']);
    ...
    _createClass(BaseFormControl, [{
        ...
        value: function buildErrorMessage() {
            ...
            var defaultErrorMessage = this.props.defaultErrorMessage || {};
        ...
        value: function displaySuccessMessage() {
    ...
    _createClass(TextInput, [{
        ...
        value: function render() {
            ...
            var multiline = props.multiline,
                ...
                domProps = _objectWithoutProperties(props, ['multiline', 'successMessage']);
    ...
    _createClass(TextInputGroup, [{
        ...
        value: function render() {
            ...
            var prepend = props.prepend,
                append = props.append,
                domProps = _objectWithoutProperties(props, ['prepend', 'append']);
...
var RadioItem = exports.RadioItem = function (_BaseFormControl4) {
    _inherits(RadioItem, _BaseFormControl4);
...
var FileInput = exports.FileInput = function (_BaseFormControl5) {
    _inherits(FileInput, _BaseFormControl5);
    ...
    function FileInput() {
        ...
        return _ret = (_temp = (_this7 = _possibleConstructorReturn(this, (_ref = FileInput.__proto__ || Object.getPrototypeOf(FileInput)).call.apply(_ref, [this].concat(args))), _this7), _this7.customfilterProps = function () {
            var props = _this7.filterProps();
...
var SelectGroup = exports.SelectGroup = function (_BaseFormControl6) {
    _inherits(SelectGroup, _BaseFormControl6);
...
var Checkbox = exports.Checkbox = function (_BaseFormControl7) {
    _inherits(Checkbox, _BaseFormControl7);
    ...
    _createClass(Checkbox, [{
        ...
        value: function render() {
            ...
            var label = props.label,
                ...
                domProps = _objectWithoutProperties(props, ['label', 'containerClassName', 'containerStyle', 'className']);

            return _react2.default.createElement(
                'div',
                { className: containerClassName, style: containerStyle },
                _react2.default.createElement('input', _extends({ type: 'checkbox', className: this.props.className }, domProps, { ref: this.inputRef, onChange: this.handleChange })),
                _react2.default.createElement(
                    'label',
...
var ValidationForm = exports.ValidationForm = function (_React$Component2) {
    ...
    function ValidationForm() {
        ...
        return _ret2 = (_temp2 = (_this10 = _possibleConstructorReturn(this, (_ref2 = ValidationForm.__proto__ || Object.getPrototypeOf(ValidationForm)).call.apply(_ref2, [this].concat(args))), _this10), _this10.inputs = {}, _this10.attachToForm = function (component) {
            ...
            if (form.checkValidity() === false) {
                ...
                if (_this10.props.onErrorSubmit) _this10.props.onErrorSubmit(event, formData, inputArr);
    ...
    _createClass(ValidationForm, [{
        ...
        value: function registerChildren(children) {
            ...
            var newChildren = _react2.default.Children.map(children, function (child) {
                ...
                if (_this11.isBaseFormControl(child.type)) {
                    return _react2.default.cloneElement(child, _extends({}, child.props, {
                        attachToForm: _this11.attachToForm,
                        detachFromForm: _this11.detachFromForm,
                        immediate: _this11.props.immediate,
                        defaultErrorMessage: _this11.props.defaultErrorMessage
                    }));
                } else {
                    if (typeof child === 'string') return child;
                    return _react2.default.cloneElement(child, {
                        children: typeof child.props.children === "string" ? child.props.children : _this11.registerChildren(child.props.children)
                    });
                }
            });
            return newChildren;
